...
(function () {
    ...
    /** @scope me.ParticleEmitter.prototype */
    {
        ...
        reset: function (settings) {
	        ...
	        // CHANGED
            this.renderable = settings.renderable || defaults.renderable;
...
(function () {
    ...
    /** @scope me.Particle.prototype */
    {
        ...
        init : function (emitter) {
            // Call the super constructor
	        // CHANGED
            me.Renderable.prototype.init.apply(this, [emitter.getRandomPoint(), emitter.renderable.width, emitter.renderable.height]);
                       
            // Particle will always update
            this.alwaysUpdate = true;	  
		
	        // CHANGED
            // Cache the renderable reference
            //this.renderable = new me.SpriteObject (0, 0, me.loader.getImage("explosion"));
            this.renderable = emitter.renderable;
            ...
            if (!emitter.followTrajectory) {
                this.renderable.angle = Number.prototype.random(emitter.minRotation, emitter.maxRotation);
            }
        },
        ...
        update : function (dt) {
            ...
            this.renderable.setOpacity(ageRatio);
	        ...
	        if (this.renderable.scale)
		        this.renderable.resizeV(scale);
	    ...
	    // CHANGED
	    // Added <meta charset="utf-8"> in examples
	    // Mudar todos exemplos
        draw : function (context) {
	        this.renderable.draw(context);
